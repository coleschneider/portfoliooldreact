...
export const workConfig = [
  {
    ...
    cardImage: JuniperSquare,
    position: 'Software Engineer II',
    link: 'https://junipersquare.com',
    details: [
      {
        title: `Juniper Square (SWE II)`,
        body: `At Juniper Square, I lead the development of multiple features in the fund administration service pipeline. These features included identity checks with KYC/AML, document upload and DocuSign integration, retries / queues with webhooks and more.`,
      },
      {
        title: `Fund Administration Service`,
        body: (
          <>
            I began my time at Juniper Square working on the subscription service which helped the
            company claim over 1.4 trillion in real estate assets managed. The refactor also
            included an extension into the identity verification service. A deep dive technical
            explanation of how my team built it can be found{' '}
            <a
              target="_blank"
